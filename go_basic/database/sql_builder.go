...
func SqlInsert() {
    ...
    insertBuilder = insertBuilder.InsertInto("student").Cols("name", "province", "city", "enrollment").Values("小明", "河南", "郑州", "2015-01-01") //除InsertInto也支持ReplaceInto
    for i := 0; i < 3; i++ {
    ...
    fmt.Println(args) // [小明 河南 郑州 2015-01-01 bZ72 河南 郑州 2025-09-10 CeKQ 河南 郑州 2025-09-11 Ip1p 河南 郑州 2025-09-12]
}
